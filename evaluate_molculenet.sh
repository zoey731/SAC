...
[ -z "${data_path}" ] && data_path='./datasets/molecule/bace'
[ -z "${save_path}" ] && save_path='/home/duanjw/workspace/OStars/ZJ/Transformer_bias_add_moleculenet/logs/exp-dataset-molnet-bace-lr-5e-6-end_lr-1e-9-tsteps-2000-wsteps-200-L12-D768-F768-H32-SLN-false-BS128-CLIP1-dp0.1-attn_dp0.1-wd0.0-dpp0.0'
