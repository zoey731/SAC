...
[ -z "${save_path}" ] && save_path='/home/zhoujie/Transformer_bias_add/logs/exp-dataset-qm9H-lr-7e-5-end_lr-1e-9-tsteps-600000-wsteps-10000-L12-D768-F768-H32-SLN-false-BS256-CLIP5-dp0.1-attn_dp0.1-wd1e-2-dpp0.0/SEED42-TASK3-LOSS-L1-STD-no_std-RF-cls'
...
[ -z "${task_idx}" ] && task_idx=3 # 必须和你训练时一样
