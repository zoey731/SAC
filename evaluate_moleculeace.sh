...
[ -z "${data_path}" ] && data_path="./datasets/moleculeace/${task_idx}"
[ -z "${save_path}" ] && save_path='/home/zhaoqc/Transformer_bias_add_moleculeace/logs/exp-dataset-moleculeace-CHEMBL204_Ki-lr-1e-4-end_lr-1e-5-tsteps-12000-wsteps-2000-L12-D768-F768-H32-SLN-false-BS32-CLIP5-dp0.1-attn_dp0.1-wd1e-5-dpp0.0/SEED42-TASKCHEMBL204_Ki-LOSS-L2-STD--RF-cls'
