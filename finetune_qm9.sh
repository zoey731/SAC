...
[ -z "${MASTER_PORT}" ] && MASTER_PORT=10077
[ -z "${OMPI_COMM_WORLD_SIZE}" ] && OMPI_COMM_WORLD_SIZE=1

[ -z "${save_prefix}" ] && save_prefix='exp'
[ -z "${ckpt_path}" ] && ckpt_path='/home/zhoujie/Transformer_bias_add/L12-old.pt'
# [ -z "${ckpt_path}" ] && ckpt_path='/home/duanjw/workspace/OStars/ZJ/Transformer_bias_add/logs/exp-dataset-qm9H-lr-7e-5-end_lr-1e-9-tsteps-600000-wsteps-60000-L12-D768-F768-H32-SLN-false-BS128-CLIP5-dp0.0-attn_dp0.1-wd0.0-dpp0.0/SEED42-TASK0-LOSS-L1-STD-no_std-RF-cls/checkpoint_best.pt'
...
python -m torch.distributed.launch --use_env --nproc_per_node=$n_gpu --master_port=$MASTER_PORT $ddp_options train.py \
	...
	--task graph_prediction_qm9 --criterion graph_prediction_qm9 --arch transformer_m --load-qm9  --num-classes 1 \
